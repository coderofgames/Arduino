...
have used for a switch to start the sweep, so use whatever button you like there. At this stage the device must be
reset after a sweep, and since the memory is low (on my Arduino Nano) I have not set up variable sweeps, so I just
